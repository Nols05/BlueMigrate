    ...
    return (
        <section className="py-24 lg:pt-64">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mb-12">
                    <h2 className="font-manrope text-5xl text-center font-bold text-white mb-4">Get Featured</h2>
                    <p className="text-gray-300 text-xl text-center leading-6">Get hundreds of eyes on your Bluesky account</p>
